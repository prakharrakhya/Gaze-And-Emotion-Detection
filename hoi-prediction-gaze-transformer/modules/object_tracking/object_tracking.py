...
class ObjectTracking:
    ...
    def __init__(
        self,
        yolo_weights_path: str = path_new+"/weights/yolov5/yolov5l.pt",
        deep_sort_model_dir: str = path_new+"/weights/deep_sort/",
        config_path: str = path_new+"/configs/object_tracking.yaml",
        device="cuda:0",
    ):
